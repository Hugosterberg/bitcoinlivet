 ...
 * getAssetAllocation in features/bitcoin-data/data/live-data.ts) and combined with these.
 *
 * Uppdatera siffrorna här: features/bitcoin-data/data/assets.ts → assetClassEstimates.
