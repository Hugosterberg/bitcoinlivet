...
import { purchasingPower } from "@/features/bitcoin-data/data/metrics";
            ...
            active && payload?.length ? (
              <ChartTooltipCard
                ...
                rows={[
                  {
                    label: "Kontanter",
                    value: String(payload.find((p) => p.dataKey === "cash")?.value ?? ""),
                    color: chartColors.gray,
                  },
                  {
                    label: "Knappa pengar",
                    value: String(payload.find((p) => p.dataKey === "hardMoney")?.value ?? ""),
